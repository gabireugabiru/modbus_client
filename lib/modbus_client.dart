...
class ModbusElementType {
  ...
  static const ModbusElementType discreteInput =
      ModbusElementType(false, ModbusFunctionCode.readDiscreteInputs);
  ...
  static const ModbusElementType inputRegister =
      ModbusElementType(true, ModbusFunctionCode.readInputRegisters);
  ...
  const ModbusElementType(this.isRegister, this.readFunction,
